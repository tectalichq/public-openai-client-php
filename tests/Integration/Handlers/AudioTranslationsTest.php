...
use Tectalic\OpenAi\Models\AudioTranslations\CreateRequest;
use Tectalic\OpenAi\Models\AudioTranslations\CreateResponse;
use Tests\MockUri;
...
final class AudioTranslationsTest extends TestCase
{
    ...
    public function testCreateMethod(): void
    {
        ...
        $create = $this->client->audioTranslations()->create(new CreateRequest(['file' => 'vfs://root/file', 'model' => 'whisper-1']));
