...
use Tectalic\OpenAi\Models\ImagesVariations\CreateImageResponse;
use Tests\MockUri;
...
final class ImagesVariationsTest extends TestCase
{
    ...
    public function testCreateImageMethod(): void
    {
        ...
        $createImage = $this->client->imagesVariations()->createImage(new CreateImageRequest(['image' => 'vfs://root/image']));
