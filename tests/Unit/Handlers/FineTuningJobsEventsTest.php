...
final class FineTuningJobsEventsTest extends TestCase
{
    ...
    public function testMissingRequest(): void
    {
        ...
        (new FineTuningJobsEvents())->getRequest();
    }
    ...
    public function testUnsupportedContentTypeResponse(): void
    {
        ...
        $handler = new FineTuningJobsEvents();
    ...
    {
        $request = (new FineTuningJobsEvents())
            ->listFineTuning('ft-AF1WoRqd3aJAHsqc9NY7iL8F', ['after' => 'alpha0', 'limit' => 20])
            ->getRequest();
