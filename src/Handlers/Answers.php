...
final class Answers
{
     ...
     * The endpoint first searches over provided documents or files to find relevant
     * context. The relevant context is combined with the provided examples and
     * question to create the prompt for completion.
     *
     * Operation URL: POST /answers
     * Operation ID:  createAnswer
     *
