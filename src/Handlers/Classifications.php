...
use Tectalic\OpenAi\Models\Classifications\CreateRequest;
use Tectalic\OpenAi\Models\Classifications\CreateResponse;
use Throwable;
...
final class Classifications
{
     ...
     * to select the ones most relevant for the particular query. Then, the relevant
     * examples
     * are combined with the query to construct a prompt to produce the final label via
     * the
     ...
     *
     * Operation URL: POST /classifications
     * Operation ID:  createClassification
     *
