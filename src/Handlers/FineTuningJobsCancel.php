...
final class FineTuningJobsCancel
{
    /** @var Client */
    private $client;
     ...
     * @return self
     */
    public function fineTuning($fineTuningJobId): self
    {
        $url = sprintf('/fine_tuning/jobs/%s/cancel', $fineTuningJobId);
        $this->setRequest($this->client->post(
            $url,
            null,
            []
        ));
        $this->modelType = FineTuningResponse::class;
        return $this;
    }
