...
final class FineTuningJobsEvents
{
    /** @var Client */
    private $client;
     ...
     *
     * Operation URL: GET /fine_tuning/jobs/{fine_tuning_job_id}/events
     ...
     * @return self
     */
    public function listFineTuning($fineTuningJobId, $queryParams = []): self
    {
        $url = sprintf('/fine_tuning/jobs/%s/events', $fineTuningJobId);
        ...
        $this->modelType = ListFineTuningResponse::class;
        return $this;
    }
