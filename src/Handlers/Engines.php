...
final class Engines
{
     ...
     *
     * Operation URL: GET /engines
     * Operation ID:  listEngines
     *
     * @api
     * @return self
     */
     ...
     *
     * Operation URL: GET /engines/{engine_id}
     * Operation ID:  retrieveEngine
     *
     ...
     * @return self
     */
    public function retrieve($engineId): self
    {
        $url = sprintf('/engines/%s', $engineId);
        $this->setRequest($this->client->get(
            $url,
            null,
            []
